...
import main = require('~sp-request~request~form-data/lib/form_data');
export = main;
}
...
export * from '~sp-request~request~tough-cookie/lib/cookie';
}
...
import main = require('~sp-request~request/index');
export = main;
}
...
import main = require('~sp-request~bluebird/bluebird');
export = main;
}
