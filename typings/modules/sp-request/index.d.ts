...
import * as spauth from '~sp-request~node-sp-auth';
...
declare module '~sp-request~node-sp-auth~bluebird' {
// Type definitions for Bluebird v3.x.x
// Project: http://bluebirdjs.com
...
declare module '~sp-request~node-sp-auth/lib/src/auth/IAuthResponse' {
...
declare module '~sp-request~node-sp-auth/lib/src/auth/IAuthOptions' {
...
declare module '~sp-request~node-sp-auth/lib/src/index' {
import * as Promise from '~sp-request~node-sp-auth~bluebird';
import { IAuthResponse } from '~sp-request~node-sp-auth/lib/src/auth/IAuthResponse';
import { IAuthOptions } from '~sp-request~node-sp-auth/lib/src/auth/IAuthOptions';
export function getAuth(url: string, options: IAuthOptions): Promise<IAuthResponse>;
export * from '~sp-request~node-sp-auth/lib/src/auth/IAuthOptions';
}
declare module '~sp-request~node-sp-auth' {
export * from '~sp-request~node-sp-auth/lib/src/index';
}
...
export * from '~sp-request/lib/src/core/SPRequest';
export * from '~sp-request/lib/src/core/ISPRequest';
export { IAuthOptions, IOnlineAddinCredentials, IOnPremiseAddinCredentials, IOnpremiseUserCredentials, IUserCredentials, IBasicOAuthOption } from '~sp-request~node-sp-auth';
}
declare module 'sp-request/lib/src/index' {
